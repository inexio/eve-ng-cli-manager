...
// StartNodesCmd represents the startNodes command
var StartNodesCmd = &cobra.Command{
	Use:   "nodes",
	Short: "Starts all nodes",
	Long:  `Starts every node within the provided lab`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		//Perform StartNodes operation
		err = client.StartNodes(lab)
		if err != nil {
			log.Error().
				Msg("Error during StartNodes")
			os.Exit(1)
		}

		fmt.Println("Successfully started all nodes.")
	},
}
